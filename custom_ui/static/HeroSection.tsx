  ...
  return (
    <article className={"py-6 space-y-4 text-white"}>
      ...
      <hgroup>
        ...
        <SectionTextBody>
          <p className={"lora text-base font-[300]"}>
            I&apos;m primarily a web developer, mainly working with languages like TypeScript and PHP, and I also have commercial experience
            in React Native. In my spare time I lean more into lower level programming.
          </p>
        </SectionTextBody>
      </hgroup>
      <hgroup>
